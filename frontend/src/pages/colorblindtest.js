...
class ColorBlindTest extends Component {
        ...
        return (
            <Row className={'justify-content-center no-margin-row'}>
                <Col lg={6} className={'text-box text-justify'}>
                    <p className='colorblindtest'>We are sorry. If you have a color deficiency, we cannot include you in the experiment. Please close this page. </p>
