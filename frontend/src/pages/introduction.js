      ...
      <>
        <Row className={'justify-content-center no-margin-row'}>
          ...
          <div className={'terms-container'}>
            <div className='terms'>
              <p>We invite you to participate in a research study being conducted by investigators from Washington University in St. Louis. The purpose of the study is to understand how the design of a visualization affects understanding, credibility, and perceived motive.</p>
              <p>If you agree to participate, we would like you to answer multiple choice questions about 16 data visualizations. For each question, you will see a data visualization and questions soliciting your opinion about the design. There are no wrong answers, and we ask that you choose the options that best describe how you feel about the design. At the end, you will complete a brief demographic survey.</p>
              ...
              <p>You will be paid for being in this research study. You will receive a pay of $5 for completing this quiz. At the end of the study, copy your survey code back to Prolific to receive your payment.</p>
